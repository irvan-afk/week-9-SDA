// Buatlah ADT Non Binary Tree dengan alokasi statis / representasi Kontigu
// (menggunakan Array) dengan Struktur data (setiap node) tddr subvar :
// info : var tunggal beritpe Integer (boleh diganti karakter)
// posisi_parent, posisi_first_son, posisi_next_brother : var tunggal betipe integer
// (jadi menggunakan array bertipe komposit)

// Spesifikasi (*.h) adalah sebagai berikut :
#ifndef nbtrees_h
#define nbtrees_h
#include "BOOLEAN.H"
#include "stdio.h"
